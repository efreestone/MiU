...
$('#addItem').on('pageinit', function(){
	...
	// Dispaly data from local storage
    ...
    function editItem() {
	    ...
	    gE("eventType").value = item.events[1];
	    ...
	    editSubmit.addEventListener("click", editItem);
    ...
    getSelectedRadio();
        var item         = {};
            item.events   = ["Event:", gE("eventType").value]; //Event type selector
    ...
    //Variable defaults
    var attendValue; // Attend radio buttons
	
	//any other code needed for addItem page goes here
	var save = gE("submit");
    save.addEventListener("click", saveData); //Save Date Event Listener
